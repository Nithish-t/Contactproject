...
const ContactList = () => {
    ...
    let { loading, contacts, filteredcontacts, errormesssage } = state;
                                ...
                                <form className='row'>
                                    <div className='col'>
                                        <div className=' mb-2'>
                                            ...
                                            type='text' className='form-control' placeholder='Serach Names' />
                                        </div>
                                    </div>
                                    <div className='col'>
                                        <div className='mb-2'>
                                ...
                                <div className='card-body'>
                                    <div className='row align-items-center'>
                                        ...
                                        <div className='col-md-7'>
                                            <ul className='list-group'>
                                                <li className='list-group-item list-group-item-action'>
                                                    Name: <span className='fw-bold'>Nithish</span>
                                                </li>
                                                <li className='list-group-item list-group-item-action'>
                                                    Mobile: <span className='fw-bold'>7013823314</span>
                                                </li>
                                                <li className='list-group-item list-group-item-action'>
                                                    Email: <span className='fw-bold'>Nithish.t98@gmail.com</span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div className='col-md-1 d-flex flex-column align-items-center '>
